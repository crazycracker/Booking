...
!function (t) {
    ...
    function _t(n, i) {
        ...
        this.initCurrentDate(), F.renderView = u, F.getSuggestedViewHeight = function () {
            ...
            var t = F.getNow(), e = P.buildRangeInfo(t), n = P.buildPrevRangeInfo(F.currentDate),
        ...
        function f(e, n) {
            ...
            if (o) t.isFunction(o) ? (U.pushLoading(), o.call(U, j.clone(), q.clone(), U.options.timezone, function (t) {
                ...
                if (a) {
                    ...
                    var h = t.extend({}, l || {}), g = lt(e.startParam, U.options.startParam),
                        p = lt(e.endParam, U.options.endParam), v = lt(e.timezoneParam, U.options.timezoneParam);
    ...
    re.push("_fullCalendar"), re.push("_ambigTime"), re.push("_ambigZone"), qt.moment = function () {
        ...
        function o(t) {
            for (var e, n = [],
                     i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);)e[1] ? n.push.apply(n, a(e[1])) : e[2] ? n.push({maybe: o(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push.apply(n, a(e[5]));
            return n
        }
    ...
    ve.mixin({
        ...
        buildSegResizeListener: function (t, e) {
            var n, i, r = this, a = this.view, l = a.calendar, u = t.el, c = t.event, d = l.getEventEnd(c),
    ...
    var me = qt.DayTableMixin = {
        ...
        updateDayTable: function () {
            for (var t, e, n, i = this.view, r = this.start.clone(), s = -1, o = [],
                     a = []; r.isBefore(this.end);)i.isHiddenDay(r) ? o.push(s + .5) : (s++, o.push(s), a.push(r.clone())), r.add(1, "days");
        ...
        renderHeadDateCellHtml: function (t, e, n) {
            var i = this.view, r = q(t, i.activeRange), s = ["fc-day-header", i.widgetHeaderClass],
    ...
    ye.mixin({
        rowStructs: null, unrenderEvents: function () {
            ...
            var r, s, o, a, l, u, c, d = this.colCnt, h = this.buildSegLevels(n), f = Math.max(1, h.length),
                g = t("<tbody/>"), p = [], v = [], m = [];
            for (r = 0; r < f; r++) {
        ...
        segPopover: null, popoverSegs: null, removeSegPopover: function () {
            ...
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(i.length)).on("click", function (o) {
                var a = s.opt("eventLimitClick"), l = r.getCellDate(e, n), u = t(this), c = r.getCellEl(e, n),
            ...
            r = 1 == this.rowCnt ? a.el : this.rowEls.eq(t), s = {
                ...
                hide: function () {
                    if (o.popoverSegs)for (var t,
                                               e = 0; e < o.popoverSegs.length; ++e)t = o.popoverSegs[e], a.publiclyTrigger("eventDestroy", t.event, t.event, t.el);
            ...
            var r, s = this.view, o = s.opt("theme"), a = this.getCellDate(e, n).format(s.opt("dayPopoverFormat")),
                l = t('<div class="fc-header ' + s.widgetHeaderClass + '"><span class="fc-close ' + (o ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + ut(a) + '</span><div class="fc-clear"/></div><div class="fc-body ' + s.widgetContentClass + '"><div class="fc-event-container"></div></div>'),
            ...
            for (var i, r = this.rowStructs[t].segMatrix, s = n || 0,
                     o = []; s < r.length;)i = r[s][e], i && o.push(i), s++;
            return o
        }
    });
    ...
    Se.mixin({
        ...
        fgSegHtml: function (t, e) {
            var n, i, r, s = this.view, o = t.event, a = s.isEventDraggable(o),
                ...
                u = !e && t.isEnd && s.isEventResizableFromEnd(o), c = this.getSegClasses(t, a, l || u),
                d = dt(this.getSegSkinCss(t));
    ...
    var Ee = qt.Calendar = St.extend({
        ...
        buildViewSpec: function (t) {
            for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], c = [], d = [],
    ...
    Ee.prototype.mutateSeg = function (t, e) {
        ...
        var n = e.source || {}, i = lt(e.constraint, n.constraint, this.options.eventConstraint),
    ...
    var Ge = we.extend({
        ...
        segSelector: ".fc-list-item", hasDayInteractions: !1, spanToSegs: function (t) {
            for (var e, n = this.view, i = n.renderRange.start.clone().time(0), r = 0,
                     s = []; i < n.renderRange.end;)if (e = N(t, {
                    start: i,
